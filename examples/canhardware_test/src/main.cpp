...
static bool Can2Callback(uint32_t id, uint32_t *data, uint8_t dlc)
{
    PrintCanFrame(id, data, dlc);
    return true;
}

static bool Can3Callback(uint32_t id, uint32_t *data, uint8_t dlc)
{
    PrintCanFrame(id, data, dlc);
    return true;
}
...
static FunctionPointerCallback can1Callback(Can1Callback, SetCanFilters);
static FunctionPointerCallback can2Callback(Can2Callback, SetCanFilters);
static FunctionPointerCallback can3Callback(Can3Callback, SetCanFilters);
